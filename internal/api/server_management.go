...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/context-compression/stats", s.mgmt.GetContextCompressionStats)
		...
		mgmt.GET("/routing/providers", s.mgmt.GetProviderRouting)
		mgmt.PUT("/routing/providers/:name", s.mgmt.PutProviderRouting)
		mgmt.DELETE("/routing/providers/:name", s.mgmt.DeleteProviderRouting)
